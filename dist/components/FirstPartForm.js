            ...
            React.createElement("div", { className: 'first_part' },
                React.createElement("div", { className: 'first_part_inside' },
                    ...
                    React.createElement("div", { className: 'wrap_title_yours' },
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check1 ? 'title' : '', form: 'checkPersonal1', value: 'None' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check2 ? 'title' : '', form: 'checkPersonal1', value: 'Prof.' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check3 ? 'title' : '', form: 'checkPersonal1', value: 'Dr.' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check4 ? 'title' : '', form: 'checkPersonal1', value: 'PhD' }))),
                React.createElement("div", { className: 'second_part_inside' },
                    ...
                    React.createElement("div", { className: 'wrap_title_salut' },
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check21 ? 'salutation' : '', form: 'checkPersonal1', value: 'Mr' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check22 ? 'salutation' : '', form: 'checkPersonal1', value: 'Mrs' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check23 ? 'salutation' : '', form: 'checkPersonal1', value: 'Ms' }))),
                React.createElement("div", { className: 'name_part_inside' },
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal1', name: 'name', required: true, onChange: (e) => document.getElementById('nameHid').value = e.target.value, className: 'com_input', placeholder: 'Name' })),
                React.createElement("div", { className: 'surname_part_inside' },
                    React.createElement("p", { className: 'title_salut' }, "Last name"),
                    React.createElement("input", { type: 'text', form: 'checkPersonal1', name: 'lastname', required: true, onChange: (e) => document.getElementById('lastnameHid').value = e.target.value, className: 'com_input', placeholder: 'Last name' })),
                React.createElement("div", { className: 'third_part_inside' },
                    React.createElement("p", { className: 'title_salut' }, "Date of birth"),
                    React.createElement("input", { type: 'text', form: 'checkPersonal1', name: 'date', required: true, onChange: (e) => document.getElementById('dateHid').value = e.target.value, ref: this.dateInput, placeholder: 'DD/MM/YYYY', onFocus: () => {
                ...
                React.createElement("div", { className: 'five_part_inside' },
                    ...
                    React.createElement("div", { className: 'wrap_title_nation' },
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check31 ? 'nationalities' : '', form: 'checkPersonal1', value: '0' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check32 ? 'nationalities' : '', form: 'checkPersonal1', value: '1' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check33 ? 'nationalities' : '', form: 'checkPersonal1', value: '2' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check34 ? 'nationalities' : '', form: 'checkPersonal1', value: '3' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check35 ? 'nationalities' : '', form: 'checkPersonal1', value: '4' }),
                        ...
                        React.createElement("input", { type: 'hidden', name: this.state.check36 ? 'nationalities' : '', form: 'checkPersonal1', value: '5' }))))));
    }
}
