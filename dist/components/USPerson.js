        ...
        return (React.createElement("div", { className: 'wrap_us' },
            React.createElement("div", { className: 'us' },
                ...
                React.createElement("div", { className: 'choose_us' },
                    ...
                    React.createElement("input", { type: 'hidden', name: this.state.check1 ? 'usPerson' : '', form: 'checkPersonal1', value: 'No US person' }),
                    ...
                    React.createElement("input", { type: 'hidden', name: this.state.check2 ? 'usPerson' : '', form: 'checkPersonal1', value: 'Former US person' }),
                    ...
                    React.createElement("input", { type: 'hidden', name: this.state.check3 ? 'usPerson' : '', form: 'checkPersonal1', value: 'US person' })),
                ...
                React.createElement("div", { className: 'wrap_usPerson dispNone', ref: this.secondCase },
                    React.createElement("p", { className: 'each_under_us' },
                        React.createElement("p", { className: 'wrap_main_checkbox2', ref: this.firstBlue },
                            React.createElement("input", { type: 'checkbox', form: 'checkPersonal1', onChange: this.changeInputColor1, ref: this.main_checkbox, className: 'main_checkbox' }),
                            React.createElement("input", { type: 'hidden', name: 'bornInUs', form: 'checkPersonal1', ref: this.main_checkbox7, value: 'I was not born in the U.S.' })),
                    ...
                    React.createElement("p", { className: 'each_under_us' },
                        React.createElement("p", { className: 'wrap_main_checkbox2', ref: this.secondBlue },
                            React.createElement("input", { type: 'checkbox', form: 'checkPersonal1', onChange: this.changeInputColor2, ref: this.main_checkbox2, className: 'main_checkbox' })),
                        React.createElement("input", { type: 'hidden', name: 'greenCard', form: 'checkPersonal1', ref: this.main_checkbox8, value: 'I am not a holder of either a returned or administratively or judicially revoked U.S. Green Card (irrespective expiry date)' }),
                ...
                React.createElement("div", { className: 'wrap_usPerson2 dispNone', ref: this.thirdCase },
                    ...
                    React.createElement("p", { className: 'each_under_us' },
                        ...
                        React.createElement("input", { type: 'hidden', name: 'possessionGreenCard', ref: this.main_checkbox5, form: 'checkPersonal1', value: 'You are not in possession of a U.S. Green Card\u2028(irrespective expiry date)' }),
                    ...
                    React.createElement("p", { className: 'each_under_us' },
                        React.createElement("p", { className: 'wrap_main_checkbox2', ref: this.fourthBlue },
                            React.createElement("input", { type: 'checkbox', form: 'checkPersonal1', onChange: this.changeInputColor4, ref: this.main_checkbox4, className: 'main_checkbox' })),
                        React.createElement("input", { type: 'hidden', name: 'subPresTest', form: 'checkPersonal1', ref: this.main_checkbox6, value: 'You do not meet the Substantial Presence Test' }),
