        ...
        return (React.createElement("div", { className: 'wrap_Employment' },
            React.createElement("div", { className: 'employment' },
                ...
                React.createElement("div", { className: 'for_student dispNone' },
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: this.state.check5 ? true : false, placeholder: 'University', onChange: (e) => document.getElementById('universityHid').value = e.target.value, className: 'alternative_inputs long_input' }),
                    React.createElement("p", { className: 'title_salut' }, "Faculty/course"),
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: this.state.check5 ? true : false, placeholder: 'Faculty/course', onChange: (e) => document.getElementById('facultyHid').value = e.target.value, className: 'alternative_inputs long_input' })),
                React.createElement("div", { className: 'main_info' },
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: true, placeholder: 'Company name', onChange: (e) => document.getElementById('companyEmplNameHid').value = e.target.value, id: 'spec_inp5', className: 'alternative_inputs' }),
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: true, placeholder: 'Company address', onChange: (e) => document.getElementById('companyEmplAddressHid').value = e.target.value, className: 'alternative_inputs' }),
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: true, ref: this.dateInput, onChange: (e) => document.getElementById('companyEmplDateHid').value = e.target.value, placeholder: 'DD/MM/YYYY', id: 'spec_inp6', onFocus: () => {
                            if (this.dateInput.current != null) {
                                this.dateInput.current.type = "date";
                            }
                        }, className: 'com_input' }),
                    React.createElement("select", { id: 'selectCountrLow', onChange: (e) => document.getElementById('companyEmplCountryHid').value = e.target.value, className: 'com_input' }, this.state.allCountries.map((item, key) => (React.createElement("option", { value: key == 0 ? '' : item.name, disabled: key == 0 ? true : false, selected: key == 0 ? true : false }, item.name)))),
                    React.createElement("p", { className: 'title_salut', id: 'tit_website' }, "Website"),
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: true, placeholder: 'Website', onChange: (e) => document.getElementById('companyEmplWebsiteHid').value = e.target.value, className: 'alternative_inputs', id: 'website' }),
                    React.createElement("p", { className: 'title_salut' }, "Line of business or industry (NOGA code)"),
                    React.createElement("select", { id: 'selectCode', onChange: (e) => document.getElementById('companyEmplCodeHid').value = e.target.value, className: 'com_input' },
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal', required: true, placeholder: this.state.profession, onChange: (e) => document.getElementById('companyEmplProfessionHid').value = e.target.value, id: 'profession_title_input', className: 'alternative_inputs long_input' }),
