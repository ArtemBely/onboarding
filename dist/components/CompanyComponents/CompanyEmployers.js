...
class CompanyEmployers extends Component {
    constructor(props, state) {
        ...
        this.changeInputColor9 = (e) => {
            ...
            document.getElementById('sameCorrespondenceCompanyHid').value = e.target.checked.toString();
        };
        this.changeOneTitle = () => {
            var _a, _b;
        ...
        this.changeInputColor21 = (e) => {
            ...
            document.getElementById('noTransfer3Hid').value = e.target.checked.toString();
        };
        this.changeInputColor22 = (e) => {
            ...
            document.getElementById('noTransfer4Hid').value = e.target.checked.toString();
        };
        this.changeWhite1 = () => {
    ...
    render() {
        return (React.createElement("div", { className: 'wrap_companyEmployers' },
            React.createElement("div", { className: 'companyEmployers' },
                ...
                React.createElement("select", { id: 'selectCode2', onChange: (e) => document.getElementById('lineOfCompanyHid').value = e.target.value, className: 'com_input' },
                ...
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('companyRegAddressHid').value = e.target.value, placeholder: 'Street, No.', id: 'alter4', className: 'alternative_inputs' }),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('companyRegCityHid').value = e.target.value, placeholder: 'City/State', className: 'alternative_inputs' }),
                React.createElement("p", { className: 'title_salut' }, "Mailbox"),
                React.createElement("p", { className: 'title_salut' }, "Country of residence"),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('companyMailBoxHid').value = e.target.value, placeholder: 'Mailbox', id: 'alter5', className: 'alternative_inputs' }),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('countryOfCompany2Hid').value = e.target.value, placeholder: 'Country of residence', className: 'alternative_inputs' }),
                React.createElement("p", { className: 'title_salut', id: 'company_postal' }, "Postal code"),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('postalCompanyCodeHid').value = e.target.value, placeholder: 'Postal code', className: 'alternative_inputs' }),
                ...
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('ammountOfCompanyHid').value = e.target.value, className: 'com_input', id: 'alter6', placeholder: 'Ammount' }),
                ...
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('bankOfCompanyHid').value = e.target.value, placeholder: 'Bank', id: '', className: 'alternative_inputs long_input' }),
                ...
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('btcCompany1Hid').value = e.target.value, placeholder: 'Indicative initial BTC transfer to PI Digital wallet', id: '', className: 'alternative_inputs long_input' }),
                React.createElement("p", { className: 'title_salut ref_curr_title' }, "BTC wallet address used for the transfer"),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('btcCompany2Hid').value = e.target.value, placeholder: 'BTC wallet address used for the transfer', id: '', className: 'alternative_inputs long_input' }),
                React.createElement("p", { className: 'title_salut ref_curr_title' }, "Indicative initial ETH transfer to PI Digital wallet"),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('ethCompany1Hid').value = e.target.value, placeholder: 'Indicative initial ETH transfer to PI Digital wallet', id: '', className: 'alternative_inputs long_input' }),
                React.createElement("p", { className: 'title_salut ref_curr_title' }, "ETH wallet address used for the transfer"),
                React.createElement("input", { type: 'text', form: 'companyForm', required: true, onChange: (e) => document.getElementById('ethCompany2Hid').value = e.target.value, placeholder: 'ETH wallet address used for the transfer', id: '', className: 'alternative_inputs long_input' }),
                ...
                React.createElement("div", { className: 'wrap_next_buttons5' },
                    React.createElement("div", { className: 'first_next_buttons' },
                        ...
                        React.createElement("button", { type: 'submit', form: 'companyForm', className: 'next_button' }, "Next"))))));
    }
}
