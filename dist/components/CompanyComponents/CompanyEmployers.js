    ...
    render() {
        return (React.createElement("div", { className: 'wrap_companyEmployers' },
            React.createElement("div", { className: 'companyEmployers' },
                ...
                React.createElement("input", { type: 'text', placeholder: 'Street, No.', id: 'alter4', className: 'alternative_inputs' }),
                ...
                React.createElement("input", { type: 'text', placeholder: 'Mailbox', id: 'alter5', className: 'alternative_inputs' }),
                ...
                React.createElement("input", { type: 'text', name: 'ammount', className: 'com_input', id: 'alter6', placeholder: 'Ammount' }),
