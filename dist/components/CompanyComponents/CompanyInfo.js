                ...
                React.createElement("div", { className: 'first_part_company' },
                    React.createElement("div", { className: 'first_part_inside', id: 'company_txt' },
                        ...
                        React.createElement("div", { className: 'wrap_title_yours_company' },
                            React.createElement("p", { className: 'each_title_yours choosen_type_blue', ref: this.firstTitle },
                                ...
                                React.createElement("input", { type: 'hidden', name: this.state.check1 ? 'stockExchange' : '', form: 'checkPersonal3', value: 'Yes' })),
                            React.createElement("p", { className: 'each_title_yours', ref: this.secondTitle },
                                ...
                                React.createElement("input", { type: 'hidden', name: this.state.check2 ? 'stockExchange' : '', form: 'checkPersonal3', value: 'No' })))),
                    React.createElement("div", { className: 'upload_extract dispNone', ref: this.uploadExtract },
                        ...
                        React.createElement("div", { className: 'dashed_block' },
                            React.createElement("input", { type: 'file', name: 'noExchangeFile', form: 'checkPersonal3', required: this.state.check1 ? false : this.state.check2 ? true : false, id: 'download_extract' }),
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal3', name: 'entityName', required: true, placeholder: 'Entity name', className: 'alternative_inputs', id: 'alter1' }),
                    React.createElement("input", { type: 'text', form: 'checkPersonal3', name: 'taxOfID', required: true, placeholder: 'Tax identification number', className: 'alternative_inputs' }),
                    ...
                    React.createElement("input", { type: 'text', form: 'checkPersonal3', name: 'countryOfReg', required: true, placeholder: 'Germany', id: 'alter2', className: 'alternative_inputs' }),
                    React.createElement("input", { type: 'text', form: 'checkPersonal3', name: 'entityType', required: true, placeholder: 'Foundation', className: 'alternative_inputs' }),
                    React.createElement("p", { className: 'title_salut' }, "Date of incorporation"),
                    React.createElement("p", { className: 'title_salut' }, "Website"),
                    React.createElement("input", { type: 'text', form: 'checkPersonal3', name: 'dateOfIncorp', required: true, ref: this.dateInput, placeholder: 'DD/MM/YYYY', id: 'alter3', onFocus: () => {
                            if (this.dateInput.current != null) {
                                this.dateInput.current.type = "date";
                            }
                        }, className: 'com_input' }),
                    React.createElement("input", { type: 'text', form: 'checkPersonal3', required: true, name: 'websiteOfComp', placeholder: 'www.', className: 'alternative_inputs' })))));
    }
}
